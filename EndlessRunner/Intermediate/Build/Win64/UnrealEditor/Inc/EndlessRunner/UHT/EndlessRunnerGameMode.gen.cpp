...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AEndlessRunnerGameMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AEndlessRunnerGameMode_Statics::ClassParams = {
		...
		0,
		0x008802ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AEndlessRunnerGameMode_Statics::Class_MetaDataParams), Z_Construct_UClass_AEndlessRunnerGameMode_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_Suric_Documents_Unreal_Projects_EndlessRunnerTPSUE5_EndlessRunner_Source_EndlessRunner_EndlessRunnerGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Suric_Documents_Unreal_Projects_EndlessRunnerTPSUE5_EndlessRunner_Source_EndlessRunner_EndlessRunnerGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AEndlessRunnerGameMode, AEndlessRunnerGameMode::StaticClass, TEXT("AEndlessRunnerGameMode"), &Z_Registration_Info_UClass_AEndlessRunnerGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEndlessRunnerGameMode), 309901152U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Suric_Documents_Unreal_Projects_EndlessRunnerTPSUE5_EndlessRunner_Source_EndlessRunner_EndlessRunnerGameMode_h_1562407592(TEXT("/Script/EndlessRunner"),
		Z_CompiledInDeferFile_FID_Users_Suric_Documents_Unreal_Projects_EndlessRunnerTPSUE5_EndlessRunner_Source_EndlessRunner_EndlessRunnerGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Suric_Documents_Unreal_Projects_EndlessRunnerTPSUE5_EndlessRunner_Source_EndlessRunner_EndlessRunnerGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
